...
class EventType(Enum):
    ...
    PVE_KILL = "pve_kill"  # Player killed NPC
    PVP_KILL = "pvp_kill"  # Player killed player
...
class EventParser:
    ...
    def _parse_kill_event(self, line: str, timestamp: Optional[datetime], 
        ...
        if is_npc_killer and not is_npc_victim:
            event_type = EventType.DEATH  # Player killed by NPC
        elif not is_npc_killer and is_npc_victim:
            event_type = EventType.PVE_KILL  # Player killed NPC
        elif not is_npc_killer and not is_npc_victim:
            event_type = EventType.PVP_KILL  # Player killed player
        else:
